...
sound1 = pygame.mixer.Sound('clearing a row.wav')
sound2 = pygame.mixer.Sound('falling terimino.wav')
# SHAPE FORMATS
S = [['.....',
      '.....',
      '..00.',
...
keys_img = pygame.image.load('keys.png')
score_img = pygame.image.load('ten-points1.png')
rules_img = pygame.image.load('rules-true.png')
#rules_img = pygame.image.load('icons8-tetris-64.png')
star_img = pygame.image.load('reward.png')
...
help_img = pygame.image.load('18436.png')
...
back_Button = Button(30, 625, back_img, 0.05)
...
def help(win):
    ...
    while run:
        ...
        inst2 = font.render('''2. When a line of blocks is created, the entire line''', 1, (139,10,80))
        win.blit(inst2, (top_left_x - 220, 420))
        inst2 = font.render('''disappears and +10 points are rewarded.''', 1, (139,10,80))
        win.blit(inst2, (top_left_x - 220, 445))
        score_button.draw(win)
        inst2 = font.render('''3. The upcoming pieces will be shown in the Next Shape section.''', 1, (155,0,240))
